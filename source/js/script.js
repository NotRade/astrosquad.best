...
const commands = {
	...
	{
		cmd: 'members',
		res: 'AstroSquad Members:<span class="red"></span><br>#<span class="red"> VortexThaGod</span><br># <span class="red"> MoonManMafia</span><br># <span class="red"> AuthZero</span><br># <span class="red"> Auth106</span><br># <span class="red"> LazyJr</span><br># <span class="red"> HellSec</span><br># <span class="red"> Majora</span><br># <span class="red"> Qixg</span>'
	},
	clowns:
	{
		cmd: 'clowns',
		res: 'Clowns:<br># <span class="red"><a href="https://astrosquad.best/clown/magenta.html" target="_blank"><u>Magenta</u></a></span> - Wannabe Hacker Threatened To Take My Site Down.<br># <span class="red"><a href="https://astrosquad.best/skids/Eternity.html" target="_blank"><u>Elternity Squad</u></a></span> - Group Full Of Skids And Wannabe Hackers | Hack My Site Please.<br># <span class="red"><a href="https://astrosquad.best/retard/daingong.html" target="_blank"><u>daingong</u></a></span> - Kids A Retard. Tried To Report My Discord With His Own Message Links.<br># <span class="red"><a href="https://astrosquad.best/seth/index.html" target="_blank"><u>LordOfWorlds</u></a></span> - Naughty Seth Toth Lying About Him Being Arrested.'
	},
	aboutme:  
	{
		cmd: 'aboutme',
		res: 'About Me:<br># <span class="red">Real Name:</span> Nathan Vince<br># <span class="red">Born:</span> ' + sMonth["6"] + ' 13 2000 <span class="red">(Age: ' + GetAge("2000-07-13") + ')</span><br># <span class="red">Country:</span> Zimbabwe<br><br><span class="red">Bio:</span><br><span class="pink"><br>Hi! My Names Nathan But I Go By Vortex Online.<br>Im A Programmer And Cheat Dev :D<br>But Most People Know Me For Being A Femboy :D<br></span><br># <span class="red">Programming:</span> HTML, CSS, JS, PHP, C++, C#, PY, LUA, JAVA.<br></span><br><span class="red">Languages:</span><br>- Chinese <span class="red">(Nihao?)</span><br>- English <span class="red">(Intermediate)</span><br>- Arabic <span class="red">(Basic)</span><br>- Japanese <span class="red">(Basic)</span><br>- Dutch <span class="red">(Good)</span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="red"><a href="https://discord.com/users/706172448696959037" target="_blank"><u>Discord</u></a></span> - My Discord Account.<br># <span class="red"><a href="https://soundcloud.com/vortex-tha-god" target="_blank"><u>SoundCloud</u></a></span> - What I Listen To.<br># <span class="red"><a href="https://steamcommunity.com/id/islaynans/" target="_blank"><u>Steam</u></a></span> - You can find me there <span class="green">Online</span> most of the time.<br># <span class="red"><a href="https://websites.niggaswine.com" target="_blank"><u>My Websites</u></a></span> - All Of My Websites.</span><br># <span class="red"><a href="https://youtube.com/VortexThaGod" target="_blank"><u>Youtube</u></a></span> - Some trash content, I post there.<br># <span class="red"><a href="https://niggaswinevpn.com" target="_blank"><u>NiggaswineVPN</u></a></span> - Best VPN Provider On The Web.'
	},
	visitors: 
	{
		cmd: 'visitors',
	...
	{
		cmd: 'help',
		res: 'Available commands:<br><br># <span class="red">aboutme</span> - Some information about me.<br># <span class="red">clear</span> - Really, it just clear. <br># <span class="red">screenfetch</span> - Fetches system information in the terminal.<br># <span class="red">links</span> - Links for others sites.<br># <span class="red">visitors</span> - How many times people visited this site.<br># <span class="red">insta [Link]</span> - Get original instagram picture.<br># <span class="red">members</span> - Shows all current astrosquad members.<br># <span class="red">clowns</span> - Hall Of Clowns.'
	}
}

var prephraseRoot = '<span class="red">root@astrosquad.best</span>:<span class="blue">~</span># ';
var prephrase = '<span class="red">visitor@astrosquad.best</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'Welcome to <span class="red">astrosquad.best</span>!<br></span><br>Made By:</span><span class="red"> VortexThaGod</span><br>Total Visits: <span class="red">' + visits + '</span><br>Terminal Updated: <span class="red">' + lastUpdate +'</span><br><a href="https://astrosquad.best/seth/index.html" target="_blank"><u>Hall Of Clowns</u></a>:<span class="red"> Most Recent Hall Of Clowns.</span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
...
$('form').on('submit', function(e) {
	...
	try {
			...
			if (vInput.startsWith("./")) {
				if (vInput === "./root/welcome.sh") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>astrosquad.best: ' + vInput + ': No such file or directory</p></div>'
					});
				}
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						res = 'astrosquad.best: No passwd entry for user ' + loginArray[2] + '';
					}
					launchCommandAsVisitor({
				...
				if (vInput === "music play") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">astrosquad.best</span> ] Usage: music [play/stop/link]</p></div>'
					});
				}
				...
				if (vInput === "friend joffrey") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">astrosquad.best</span> ] Usage: friend [name/list]</p></div>'
					});
				}
		...
		if (root > 0) {
			launchCommandAsRoot({
				cmd: $('input').val(),
				res: '<div><p>astrosquad.best: ' + $('input').val() + ': command not found</p></div>'
			});
		} else {
			launchCommandAsVisitor({
				cmd: $('input').val(),
